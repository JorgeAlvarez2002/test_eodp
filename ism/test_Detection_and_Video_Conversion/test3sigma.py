...
def check_bands_against_isrf(bands, base_paths):
    ...
    for band in bands:
        toa = to_1d_spectrum(readToa(base_paths["toa"], f"ism_toa_{band}.nc"))
        toa_referencia = to_1d_spectrum(readToa(base_paths["referencia"], f"ism_toa_{band}.nc"))
        threshold, ok = diff_band(toa_referencia, toa)
...
def main():
    ...
    base_paths = {
        "toa": Path(r"C:\Users\jorge\PycharmProjects\EOPD\EODP-TS-ISM\jorgeoutputs"),
